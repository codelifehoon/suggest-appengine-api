...
import com.google.appengine.api.search.SearchServiceFactory;import somun.appengine.AppengineUtils;
...
public class IndexServlet extends HttpServlet {
  ...
  private static final String INDEX = "testIndex2";
  ...
  public void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException {
    ...
    Document doc = index.get("CZ125");

    // Fetch a range of documents by their doc_ids
    GetResponse<Document> docs =
        index.getRange(GetRequest.newBuilder().setStartId("CZ125").setLimit(100).build());
    // [END get_document]
