...
public class AppengineUtils {
  ...
  public static void indexADocument(String indexName, Document document)
    ...
    Index index = getIndexSpec(indexName);
  ...
  public static void indexADocuments(String indexName, Iterable<Document> documents)
      throws InterruptedException {
    Index index = getIndexSpec(indexName);
    index.put(documents);
  ...
  public static Index getIndexSpec(String indexName) {
